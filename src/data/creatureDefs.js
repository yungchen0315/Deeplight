/* ============================================================================
 * creatureDefs.js — 68 種深淵圖鑑生物（企劃書第 8 節 + v1.1~Phase12 擴充）。
...
(function () {
  const CREATURE_DEFS = [
    ...
    // 歸墟
    { id: 'refluxdrifter', name: '溯洄漂游者', icon: 'c_refluxdrifter', zone: 15, rare: false,
      lore: '順著歸墟的水流被緩緩吸往深處的漂游生物，卻始終停在同一個相對位置——像是牠早就知道盡頭在哪，不急著抵達。' },
    { id: 'ringswimmer', name: '環游者', icon: 'c_ringswimmer', zone: 15, rare: false,
      lore: '沿著一圈看不見的軌道繞著歸墟之核打轉的生物，一圈又一圈，從不偏離。工程日誌量過牠的週期，發現剛好跟潛燈號當初從海面下潛到這裡花的時間一樣長。' },
    { id: 'guixusentinel', name: '歸墟守望', icon: 'c_guixusentinel', zone: 15, rare: false,
      lore: '懸在歸墟入口的巨大生物，不阻擋也不引路，只是靜靜看著每一樣被水流帶進來的東西——包括潛燈號。牠的姿態跟遠比牠淺的門檻守衛出奇地相似，只是老了太多。' },
    { id: 'returninglight', name: '歸光', icon: 'c_returninglight', zone: 15, rare: true,
      lore: '歸墟最深處升起的一點光——形狀、顏色、閃爍的節奏，跟潛燈號自己的探照燈一模一樣。先驅之影、起源之眼、甦醒者、低語者、本源、觀者，一路指向的其實是這裡：這趟往最深最黑處的下潛，從一開始就是朝著自己的光而來。目擊紀錄的最後一行寫著——原來我們一直在追的，是自己。' },
    // 薪火
    { id: 'emberdrifter', name: '餘燼漂游者', icon: 'c_emberdrifter', zone: 16, rare: false,
      lore: '身上帶著點點微光的漂游生物，那些光不會熄滅，只會慢慢飄向更深處——像是誰把一把火拆成了無數點小火苗，一路往下遞。' },
    { id: 'lightdrawfish', name: '引光魚', icon: 'c_lightdrawfish', zone: 16, rare: false,
      lore: '總是游在潛燈號探照燈光束的正前方，像是在替光引路。工程日誌注意到牠游的方向永遠朝著更深處——不是被光吸引，比較像是牠知道光該送到哪裡去。' },
    { id: 'torchsentinel', name: '薪火守望', icon: 'c_torchsentinel', zone: 16, rare: false,
      lore: '沿著薪火這片海域排成一列的守望者，每一個都捧著一小簇光。牠們不看潛燈號，全都望向更深的下方——彷彿在等某個還沒抵達的人。' },
    { id: 'thesuccessor', name: '後來者', icon: 'c_thesuccessor', zone: 16, rare: true,
      lore: '薪火最深處，潛燈號第一次在自己的「下方」看見一束光——形狀、顏色、閃爍的節奏，跟潛燈號自己一模一樣，正朝著潛燈號緩緩上升，像當年潛燈號朝著歸光下潛那樣。角色對調了：這一次，我們成了別人的歸光。訊號殘片那句「你不是第一個，也不會是最後一個」，此刻終於完整。目擊紀錄的最後只留下一句：換我們替後來的人，把燈點著。' }
  ];
