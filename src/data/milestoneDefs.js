/* ============================================================================
 * milestoneDefs.js — 74 個深度里程碑，構成一條跨越全部海域的「潛航紀錄」，跟
...
(function () {
  const MILESTONE_DEFS = [
    ...
    { id: 'm2900000', depth: 2900000, name: '歸墟盡頭', rewardSeconds: 3600000 },
    { id: 'm3100000', depth: 3100000, name: '薪火入口', rewardSeconds: 4000000 },
    { id: 'm3600000', depth: 3600000, name: '薪火之核前', rewardSeconds: 4500000 },
    { id: 'm4000000', depth: 4000000, name: '薪火深處', rewardSeconds: 5000000 },
    { id: 'm4300000', depth: 4300000, name: '薪火盡頭．目前版本最深處', rewardSeconds: 6000000 }
  ];
