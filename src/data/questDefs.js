/* ============================================================================
 * questDefs.js — 每日任務範本池（16 種），每天從中抽 3 個不重複的種類。進度一律
...
(function () {
  const QUEST_TEMPLATES = [
    ...
    { id: 'tapHard', label: '點擊水域', unit: '次', statPath: 'stats.totalTaps', target: 500, reward: 7 },
    { id: 'collect', label: '收集路過生物', unit: '隻', statPath: 'stats.totalCreaturesCollected', target: 8, reward: 5 },
    { id: 'collectHard', label: '收集路過生物', unit: '隻', statPath: 'stats.totalCreaturesCollected', target: 15, reward: 7 },
    { id: 'buyModule', label: '購買發光模組', unit: '個', statPath: 'stats.totalModulesBought', target: 25, reward: 6 },
    { id: 'buyModuleSmall', label: '購買發光模組', unit: '個', statPath: 'stats.totalModulesBought', target: 10, reward: 4 },
    ...
    { id: 'ballast', label: '升級壓載系統', unit: '次', statPath: 'stats.totalBallastUpgrades', target: 2, reward: 4 },
    { id: 'golden', label: '捕獲金燈魚', unit: '隻', statPath: 'stats.totalGoldenCaught', target: 1, reward: 5 },
    { id: 'milestone', label: '領取潛航紀錄里程碑', unit: '個', statPath: 'milestonesClaimed', target: 1, reward: 5 }
  ];
