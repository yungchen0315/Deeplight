/* ============================================================================
 * mathUtils.js — 通用數學工具：大數字格式化（萬／億／兆／京／垓／秭／穰／溝／澗／正／載／極／恆河沙／阿僧祇／那由他，或科學記號）、
...
(function () {
  ...
  function formatNum(n) {
    ...
    const units = [
      [1e60, '那由他'], [1e56, '阿僧祇'], [1e52, '恆河沙'], [1e48, '極'], [1e44, '載'], [1e40, '正'],
      [1e36, '澗'], [1e32, '溝'], [1e28, '穰'], [1e24, '秭'], [1e20, '垓'], [1e16, '京'],
      [1e12, '兆'], [1e8, '億'], [1e4, '萬']
    ];
